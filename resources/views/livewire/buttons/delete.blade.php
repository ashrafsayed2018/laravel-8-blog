<div class="bg-red-200 p-2 rounded">
     <a
     wire:click.prevent="confirmPostDeletion"
    ...
    {{-- dialog model for confirm deleting  --}}
    <x-jet-dialog-modal wire:model="confirmDeletion" >
        <x-slot name="title">حذف المقال</x-slot>
        <x-slot name="content">هل انت متأكد من حذف المقال ؟</x-slot>
        <x-slot name="footer">
